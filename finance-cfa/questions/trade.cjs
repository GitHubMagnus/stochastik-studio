...
module.exports=[
 ...
 q('b1','mock-b','b','A large country initially trades at price 10, consuming 260 and producing 160. A tariff lowers the foreign export price to 9 and raises the domestic price to 12. Consumption becomes 230 and production 170. With linear domestic curves and no other effects, the national welfare change is:',[
 ['−40.','Das zählt nur die heimischen Verzerrungsdreiecke und lässt den Terms-of-Trade-Gewinn weg.'],['+20.','Konsumenten −490, Produzenten +330 und Zolleinnahmen +180.'],['+60.','Das ist nur der Terms-of-Trade-Gewinn auf verbleibenden 60 Importen.']
 ],1,[eq('\\Delta W=-2(260+230)/2+2(160+170)/2+(12-9)(230-170)=20','Der Zoll ist 3 je Einheit, der heimische Preisanstieg nur 2. Nationale Wohlfahrt berücksichtigt beide Preisänderungen.','\\Delta W','Nationale Wohlfahrtsänderung in Geldeinheiten.'),'Alternativ: 1 × 60 Terms-of-Trade-Gewinn minus 0,5 × 2 × (30 + 10) heimische Verzerrungen = 20. Gegenmaßnahmen und ausländische Verluste sind laut Aufgabe nicht Teil dieser nationalen Rechnung.'],'tariff-welfare')
];
