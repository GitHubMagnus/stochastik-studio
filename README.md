...
- **Formeln verstehen:** Alle 171 Finance-Kapitel wurden auf Symboldefinitionen geprüft. Die Hauptformeln haben eine sichtbare Lesart und Symboltabelle; Herleitungen, Beispiele, Grafikformeln, Vergleichstabellen und Aufgaben besitzen direkt zugeordnete, aufklappbare Symbolhilfen. 1.299 Definitionseinträge erläutern Größen, Einheiten, Indizes und abweichende Konventionen für 948 unterschiedliche Kombinationen aus Kapitel und Formel. Auch die 33 Stochastik-Kapitel und die neun Kelly-Hauptformeln besitzen Symbolhilfen. [Direkt zum Zeitreihenkapitel](https://githubmagnus.github.io/stochastik-studio/#lesson-quant-11~formula).
...
- **Fachwörterbuch:** 868 alphabetisch sortierte Definitionen mit 1.831 Begriffen und Aliasen; automatische Verlinkung aus den Lerntexten und Rückverweise auf erklärende Kapitel. 469 kuratierte Einträge besitzen zusätzlich einen präzisen Rückverweis in den neuen CFA-Lernpfad.
...
43 neu ausgearbeitete Einheiten und 862 eigenständige englische Trainingsfragen
...
exakte Rangtests, Regression bis zur CAPM-Schätzung, Prognoseintervalle, historische
Simulation, Bootstrap, Monte Carlo und Datenwissenschaft. Alle acht VWL-Einheiten
sind in zusammen 100 Abschnitten ausgearbeitet: Marktformen, Konjunktur,
Fiskalpolitik, Geldpolitik, Geopolitik, internationaler Handel, Devisenmärkte und
Wechselkursrechnung. Sie vergleichen unter anderem Kostenminima, Mengenwettbewerb,
Lager- und Kreditzyklen, Schuldendynamik, geopolitische Szenarien, Zoll- und
Subventionswirkungen sowie handelbare Kreuzkurse und gedeckte Zinsparität.
Zahlungsstromtabellen erklären beide Arbitragerichtungen; Gebühren, Geld-Brief-Spannen,
Zinskonventionen und Modellgrenzen werden ausdrücklich unterschieden.
Die Abschlussanalyse umfasst zusätzlich den Analyseprozess, Bilanzanalyse sowie
Aufstellung und Auswertung der Cashflowrechnung: 53 Abschnitte erklären Quellenkritik,
Prüfungsurteile, immaterielle Werte, Goodwill, Finanzinstrumente, Verpflichtungen,
direkte und indirekte Cashflows, FCFF/FCFE und Deckungskennzahlen. Ein vollständiger
Jahresfall stimmt Bilanz, Gewinn und Zahlungen ab. Die IFRS-18-Änderungen werden
vom bisherigen IAS-7-Ausweis getrennt; Klassifikationsänderungen dürfen die
korrekt hergeleiteten freien Cashflows nicht verändern.
Weitere 45 Abschnitte behandeln Vorräte, langfristige Vermögenswerte und Ertragsteuern:
Kostenmethoden und Werthaltigkeit, laufende und periodische Lagerrechnung,
Abschreibung, Wertminderung und Zuschreibung, Anlagenüberleitungen sowie
Entstehung, Umkehr und Nutzbarkeit latenter Steuern. Mehrperiodenfälle zeigen,
...
Das integrierte Prognosekapitel ergänzt 21 Abschnitte und 32 Trainingsfälle:
Ein vollständiges Modell stimmt Plan-GuV, Bilanz, direkte und indirekte Zahlungen
sowie Kreditbedarf ab. Es erläutert Zinsrückkopplung, Prognosefehler, Wettbewerb,
Inflation, Szenarien und den Zusammenhang von Wachstum, Reinvestition und Wert.
Die Gewinnrechnung wurde auf zehn Abschnitte und 30 Trainingsfragen erweitert,
das Kennzahlensystem auf zwölf Abschnitte und 32 Fragen. Zusätzliche Fälle zeigen
Leistungsfortschritt, Aufwand über mehrere Jahre, aufgegebene Bereiche, Renditebasen,
Branchenkennzahlen und eine vollständige DuPont-Veränderungsbrücke.
Durchschnitts- und Endbestandskonventionen werden bei der Prognose ausdrücklich getrennt.
Corporate Issuers beginnt mit 14 Abschnitten zu Unternehmensformen und Eigentum
sowie 26 Trainingsfragen. Haftung, Steuern, Eigenständigkeit, Stimmrechte,
Primär- und Sekundärtransaktionen, IPO, Direktnotierung, SPAC und Going Private
werden getrennt erläutert. Beteiligungstabellen und eine berechnete Grafik
zeigen die Folgen fairer und unterbewerteter Aktienausgaben; Rechtsform,
Steuerklassifikation und Börsenstatus werden ausdrücklich unterschieden.
Das zweite Corporate-Kapitel behandelt Gläubiger, Eigentümer und weitere
Anspruchsgruppen in 16 Abschnitten mit 32 Trainingsfragen. Zahlungsreihenfolge,
Risikoverlagerung und Unterinvestition werden als zusammenhängende Zahlenfälle
hergeleitet. ESG-Faktoren führen über messbare Treiber zu Cashflows und Bewertung:
Kostenweitergabe, Klimarisiken, Umweltinvestitionen, Personalmaßnahmen und
Emissionsintensität. Zwei Grafiken zeigen Endzahlungen und die finanzielle
Gewinnschwelle einer Investition. Alle Formeln enthalten Symbol- und Einheitenhilfen.
Insgesamt 45 zusätzliche berechnete Grafiken erläutern die neuen Zusammenhänge.
Direkte Abschnittsverweise verbinden die Einheiten und passende Wörterbuchdefinitionen.

152 Lernzielreferenzen sind aktuell sowohl neuen Erklärungen als auch Trainingsfragen
...
haben bisher je 80 von 180 Fragen und bleiben gesperrt. Ihre Ethics- und Quant-Anteile
...
bisher je zwei reservierte Fragen. Der implementierte Ablauf
...
- `finance-notation/`: fachlich verfasste Formel-Lesarten und Symboldefinitionen je Kapitel. Lokale Definitionen überschreiben gemeinsame Abkürzungen; mehrdeutige Zeichen erhalten keine pauschal erratene Bedeutung.
- `finance-notation.cjs`, `finance-notation-ui.js`, `finance-notation.css`: Abdeckungsprüfung, Auswahl und unmittelbar zugeordnete Darstellung der Symbolhilfen. Bei einer Formeländerung müssen insbesondere neue Grundsymbole, Indizes, Einheiten und Konventionen mitgeprüft werden; die automatische Prüfung ersetzt diese fachliche Kontrolle nicht.
- `statistics-notation.cjs`, `statistics-notation-ui.js`, `kelly-notation.cjs`, `build-notation.cjs`: Symbolhilfen für die ursprünglichen Stochastik-Kapitel und Kelly Studio, ebenfalls vollständig offline eingebettet.
